<div>
    ...
    >
        <div class="flex justify-between">
            <p class="font-thin group-hover:font-light italic text-lg text-secondary"><?php echo e($name); ?> :</p>
        ...
        <div class="w-full rounded-md  h-8 mt-1 col-span-2 group-hover:tracking-widest transition-all flex items-center justify-center border-2 uppercase" :class="dark ? 'border-inactiveText' : 'border-primary'" :style="'background-color: #' + '<?php echo e($color); ?>'">
...
<?php /**PATH C:\Travail\Web\_Servers\BARBOFUS\resources\views/components/skins-presentation/color.blade.php ENDPATH**/ ?>
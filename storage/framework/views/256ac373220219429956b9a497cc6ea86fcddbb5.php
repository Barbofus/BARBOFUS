...
<nav id="navbar"
    ...
    <template x-if="true">
        <div x-show="showNavbar" x-transition
            ...
            <a href="<?php echo e(route('home')); ?>" :class="<?php echo e((Route::is('home')) ? 'selectedClass' : 'unselectedClass'); ?>">Accueil</a>
            <a href="<?php echo e(route('skins.index')); ?>" :class="<?php echo e((Route::is('skins.index', 'skins.show')) ? 'selectedClass' : 'unselectedClass'); ?>">Les Skins</a>

            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>" :class="<?php echo e((Route::is('login')) ? 'selectedClass' : 'unselectedClass'); ?>">Se connecter</a>
                <a href="<?php echo e(route('register')); ?>" :class="<?php echo e((Route::is('register')) ? 'selectedClass' : 'unselectedClassLast'); ?>">S'enregistrer</a>
            <?php endif; ?>
...
<?php /**PATH C:\Travail\Web\_Servers\BARBOFUS\resources\views/components/main-navbar.blade.php ENDPATH**/ ?>
...
<div x-cloak class="relative max-[500px]:order-first"
    ...
    <div class="flex items-center justify-around gap-x-2"
        ...
        <button class="h-10 w-10 mr-4"
            ...
            <img src="<?php echo e(asset('storage/images/misc_ui/simple_dice.png')); ?>" class="h-full hover:scale-90 transition-all">
        </button>
...
<?php /**PATH C:\Travail\Web\_Servers\BARBOFUS\resources\views/components/skins/sorter.blade.php ENDPATH**/ ?>
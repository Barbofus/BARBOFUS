...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.skins.sorter','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('skins.sorter'); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.skins.main-filter','data' => ['races' => $races,'winnersOnly' => $winnersOnly,'barbOnly' => $barbeOnly,'skinContent' => $skinContentWhere,'gender' => $genderWhere,'raceSelection' => $raceWhere,'searchFilterInput' => $searchFilterInput]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('skins.main-filter'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['races' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($races),'winnersOnly' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($winnersOnly),'barbOnly' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($barbeOnly),'skinContent' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($skinContentWhere),'gender' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($genderWhere),'raceSelection' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($raceWhere),'searchFilterInput' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($searchFilterInput)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
    ...
    <div class="flex flex-col bg-primary pt-0
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('skin.last-winners', [])->html();
} elseif ($_instance->childHasBeenRendered('winners-<?php echo e(rand()); ?>')) {
    $componentId = $_instance->getRenderedChildComponentId('winners-<?php echo e(rand()); ?>');
    $componentTag = $_instance->getRenderedChildComponentTagName('winners-<?php echo e(rand()); ?>');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('winners-<?php echo e(rand()); ?>');
} else {
    $response = \Livewire\Livewire::mount('skin.last-winners', []);
    $html = $response->html();
    $_instance->logRenderedChild('winners-<?php echo e(rand()); ?>', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        ...
        <div class="flex-1 flex flex-col items-center min-[1800px]:max-w-[calc(100%-25rem)] mb-10">
            <?php if(count($postIdChunks) > 0): ?>
                <?php for($i = 0; $i < $page && $i < $maxPage; $i++): ?>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('skin.skin-index-chunk', ['skinIds' => $postIdChunks[$i],'page' => $page,'itemsPerPage' => Self::ITEMS_PER_PAGE])->html();
    ...
    $response = \Livewire\Livewire::mount('skin.skin-index-chunk', ['skinIds' => $postIdChunks[$i],'page' => $page,'itemsPerPage' => Self::ITEMS_PER_PAGE]);
    $html = $response->html();
...
<?php endif; ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/skins/ResizeIndexComponent.js', 'resources/js/skins/NameScroll.js', 'resources/js/skins/ScrollListeners.js', 'resources/js/skins/AnimationsManager.js']); ?>
</div>
<?php /**PATH C:\Travail\Web\_Servers\BARBOFUS\resources\views/livewire/skin/infinite-skin-index.blade.php ENDPATH**/ ?>
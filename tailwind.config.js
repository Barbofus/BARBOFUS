    ...
    theme: {
        extend: {
            ...
            keyframes: {
                ...
                topFade: {
                    '0%': {
                        opacity: 0,
                        transform:
                            'translateY(calc(var(--custom-translate-y)*-1)) rotate(var(--tw-rotate)) scale(var(--tw-scale-x), var(--tw-scale-y))',
                    },
                    '100%': {
                        opacity: 1,
                        transform:
                            'translateY(var(--tw-translate-y)) rotate(var(--tw-rotate)) scale(var(--tw-scale-x), var(--tw-scale-y))',
                    },
                },
                textSlide: {
                ...
                dofus: {
                    '0%,80%': {
                        ...
                        animationTimingFunction: 'cubic-bezier(.05,.41,0,1)',
                    },
                    '25%,55%': {
                        transform: 'translateY(-5px) rotate(var(--tw-rotate))',
                        animationTimingFunction: 'cubic-bezier(.05,.41,0,1)',
                    },
                ...
                slideX: {
                    '0%,100%': {
                        transform:
                            'translateX(calc(var(--custom-translate-x) / 2 * -1)) scale(var(--tw-scale-x), var(--tw-scale-y))',
                    },
                    '50%': {
                        transform:
                            'translateX(calc(var(--custom-translate-x) / 2)) scale(var(--tw-scale-x), var(--tw-scale-y))',
                    },
                },
                slideY: {
                    '0%,100%': {
                        transform:
                            'translateY(calc(var(--custom-translate-y) / 2 * -1)) scale(var(--tw-scale-x), var(--tw-scale-y))',
                    },
                    '50%': {
                        transform:
                            'translateY(calc(var(--custom-translate-y) / 2)) scale(var(--tw-scale-x), var(--tw-scale-y))',
                    },
                },
                dice: {
            ...
            animation: {
                ...
                customSpin: 'customSpin var(--custom-animation-time) linear infinite',
            },
        },
    },
    plugins: [],

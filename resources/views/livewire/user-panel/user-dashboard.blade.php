<div class="flex justify-center mt-20 mb-10">
    ...
    <div
        ...
        <div class="min-[1250px]:w-[315px] max-h-[390px] font-light sticky top-32">
            ...
            <button wire:click="$set('section', 'user-details')" @click="currentPage = 'user-details'" :class="(currentPage == 'user-details') ? activeButtonClass : initButtonClass" x-cloak>
            ...
            @can('validate-skin')
                <button wire:click="$set('section', 'skins-validation')" @click="currentPage = 'skins-validation'" :class="(currentPage == 'skins-validation') ? activeButtonClass : initButtonClass" x-cloak>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            @can('admin-access')
                ...
                <button wire:click="$set('section', 'users-list')" @click="currentPage = 'users-list'" :class="(currentPage == 'users-list') ? activeButtonClass : initButtonClass" x-cloak>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                ...
                <button wire:click="$set('section', 'admin-panel')" @click="currentPage = 'admin-panel'" :class="(currentPage == 'admin-panel') ? activeButtonClass : initButtonClass" x-cloak>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">

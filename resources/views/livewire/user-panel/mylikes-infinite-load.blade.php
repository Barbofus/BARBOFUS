<div>
    <div class="animate-topFade [--custom-translate-y:50px] [--custom-animation-time:0.3s]">
        <x-utils.userpage-title :title="__('barbofus.titleMyLikes')" :subtitle="__('barbofus.descriptionLikeHistoric')" />
        ...
        <div class="flex-1 flex flex-col items-center mb-10">
            ...
            @else
                ...
                <p class="text-4xl font-normal">{{ __('barbofus.contentOuch') }} ! <span class="font-thin italic text-3xl">{{ __('barbofus.descriptionNotLiked') }}</span></p>
            @endif

<div>
    <div class="animate-topFade [--custom-translate-y:50px] [--custom-animation-time:0.3s]">
        ...
        <div class="min-[750px]:grid justify-center grid-cols-[repeat(auto-fill,40rem)] p-4 gap-4">
            @foreach($unitySkins as $key => $skin)
                ...
                <div
                    ...
                    <div class="flex flex-col min-[750px]:flex-row max-[749px]:gap-y-2 min-[750px]:gap-x-2 items-center">
                        ...
                        <div class="flex flex-col min-[750px]:flex-row min-[750px]:space-x-2 items-center min-[750px]:h-full max-[749px]:w-full">
                            ...
                            {{-- Couleurs --}}
                            <div class="min-[750px]:pl-4 flex flex-wrap min-[750px]:flex-col items-start justify-around min-[750px]:justify-between min-[750px]:h-full max-[749px]:w-full">
                                ...
                                <x-skins-presentation.color :color="$skin->color_cloth_4" :name="'Habits 4'"/>
                            </div>
                        </div>
                    </div>

                    {{-- Bouton de validation --}}
                    <div class="flex flex-col min-[750px]:flex-row max-[749px]:px-2 max-[749px]:gap-y-2 min-[750px]:gap-x-2 relative pb-8">
                        ...
                        {{--<div class="flex min-[750px]:space-x-2 flex-1" x-data="{ refused_reason: '' }">
                            ...
                            <button x-on:click="$wire.refuseUnitySkin(refused_reason, {{ $skin->id }}), refused_reason = ''" class="px-4 h-12 absolute top-0 right-0 max-[749px]:right-2 text-primary transition-all hover:rounded-3xl hover:tracking-widest heartGradient rounded-md text-md min-[750px]:text-xl hover:brightness-110 min-[750px]:static">Refuser</button>
                            <textarea
                ...
                <div
                    ...
                    <div class="flex flex-col min-[750px]:flex-row max-[749px]:gap-y-2 min-[750px]:gap-x-2 relative pb-8">
                        ...
                        <div class="flex min-[750px]:space-x-2 flex-1" x-data="{ refused_reason: '' }">
                            ...
                            <button x-on:click="$wire.refuseSkin(refused_reason, {{ $skin->id }}), refused_reason = ''" class="px-4 h-12 absolute top-0 right-0 text-primary transition-all hover:rounded-3xl hover:tracking-widest heartGradient rounded-md text-md min-[750px]:text-xl hover:brightness-110 min-[750px]:static">Refuser</button>
                            <textarea
                                type="text" name="reason" placeholder="Raison du refus ..." maxlength="128"
                                class="flex-1 h-12 p-2 rounded-md text-md text-secondary placeholder:text-inactiveText bg-primary-100"
                                x-model="refused_reason"></textarea>

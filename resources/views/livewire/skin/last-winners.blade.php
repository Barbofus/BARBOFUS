<div wire:poll.visible.60s="Refresh" id="rewards-section"
    ...
    <div class="flex flex-col items-start justify-center flex-1 w-full p-4 min-[1801px]:h-[min(100%,93rem)]">
        ...
        <!-- Header -->
        <div class="relative flex items-center justify-center w-full pl-4 mt-6 gap-x-2">
        ...
        <!-- Skins -->
        <div
            class="relative flex flex-col gap-y-12 items-center justify-center flex-1 w-full pt-14
            ...
            @foreach ($skins as $skin)
                <div wire:key="skinwinner.{{ $skin->id }}"
                    ...
                    <x-skins-presentation.winners-skin-card :skin="$skin" :showLikes="true" />
                </div>
            @endforeach
        </div>
    </div>
    ...
    <!-- Bottom border -->
    <div
        class="h-1 rounded-full goldGradientSide w-[80%]
                min-[1801px]:goldGradientTop min-[1801px]:w-1 min-[1801px]:h-[80%] min-[1801px]:order-first min-[1801px]:mt-0">
    </div>
</div>

            ...
            <div class="h-[250px] w-[600px] px-2 flex items-center fixed bottom-[35%] right-[40%] bg-red-600 text-xl text-red-100 border-r-[16px] border-red-700" x-on:click.outside="deleteVerify = false">
                ...
                <div class="pl-10">
                    ...
                    <div class="mt-10 flex justify-between">
                        <button x-on:click="$wire.DeleteUser(deleteVerify), deleteVerify = false" class="ml-8 h-[50px] w-[150px] bg-green-600 text-2xl text-green-100 border-r-[16px] border-green-700 hover:bg-green-700 hover:border-green-800 hover:font-bold">Supprimer</button>

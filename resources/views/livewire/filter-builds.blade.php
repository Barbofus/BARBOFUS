<div>
    ...
    <div class="flex justify-center mt-8">
        <button wire:click="UnselectAllRaces()" class="bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded">Afficher toutes les classes</button>
    </div>
    ...
    <div class="flex justify-center mt-8">
        <button wire:click="UnselectAllElements()" class="bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded">Afficher tous les élements</button>
    </div>

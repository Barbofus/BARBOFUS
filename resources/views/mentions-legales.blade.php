...
@section('content')
    <h1 class="text-[min(4rem,15vw)] mt-10 font-normal text-center uppercase">Mentions légales</h1>

    <section id="mentions-legales"
             class="max-w-screen-xl mx-auto px-2 py-8 font-light
             [&>p]:indent-4 [&>p]:py-1 text-secondary
             [&>a]:text-goldText [&>a]:transform [&>a:hover]:transition-all [&>a:hover]:-skew-x-12
             [&>*>a]:text-goldText [&>*>a]:transform [&>*>a:hover]:transition-all [&>*>a:hover]:-skew-x-12
             [&>*>*>a]:text-goldText [&>*>*>a]:transform [&>*>*>a:hover]:transition-all [&>*>*>a:hover]:-skew-x-12
             [&>h2]:text-4xl [&>h2]:py-8
        ...
        <p style="text-align:justify"><strong>54134 Voinemont</strong><br />
            Référencée au Registre du Commerce et des Sociétés au numéro <strong>90520214900019</strong></p>

        <p style="text-align:justify">Numéro de TVA Intracommunautaire : <strong>FR85905202149</strong><br />
            Adresse mail : <strong><a href="mailto:mathieu.lehr@gmail.com?subject=Contact a partir des mentions légales via le site barbofus.com">mathieu.lehr@gmail.com</a></strong><br />
            <br />
            Le Créateur du site internet est : <strong>Charly Mollard</strong><br />
            Le Décideur de la publication est : <strong>Mathieu LEHR</strong><br />
            Par quel moyen joindre le Directeur de publication : <strong><a href="mailto:mathieu.lehr@gmail.com?subject=Contact a partir des mentions légales via le site barbofus.com">mathieu.lehr@gmail.com</a></strong></p>
        <br />

        Le Réalisateur est : <strong>Charly Mollard</strong><br />
        Où entrer en contact avec le Concepteur : <strong><a href="mailto:charly.mollard@gmail.com?subject=Contact a partir des mentions légales via le site barbofus.com">charly.mollard@gmail.com</a></strong><br />
        <br />

        Entreprise qui assure l'hébergement : O2Switch<br />
        SASU<br />
        Registre du commerce et des sociétés (RCS) Clermont-Ferrand B 510909807<br />
        Code d'Activité principale exercée (APE) 6311Z<br />
        Num. de TVA : FR 35 510 909 807<br />
        Siège Sociale de l'hébergeur : 222-224 Boulevard Gustave Flaubert - 63000 Clermont-Ferrand - France<br />
        <br />
        <br />
        Les mentions ont été générées via <strong><a href="https://www.generateur-de-mentions-legales.com" target="_blank">ce site</a></strong><br />
        ...
        <p style="text-align:justify"><strong>4. Propriété intellectuelle :</strong><br />
            <br />
            Mathieu LEHR est le propriétaire exclusif de l'intégralité des droits de propriété intellectuelle ou détient les droits et autorisations d'usage sur tous les éléments accessibles sur le site web, tant structurellement que sur les articles et textes, images, graphismes, icônes, sons, logiciels…<br />
            Toute reproduction totale ou partielle du site suivant barbofus.com, représentation, edition, adaptation totalement ou partiellement de l'un  de ces éléments, quel que soit le moyen ou le procédé utilisé, est strictement interdite, excepté acceptation écrite préalable de Mathieu LEHR, propriétaire du site internet à l'email : mathieu.lehr@gmail.com, à défaut, elle sera considérée comme constitutive d'une contrefaçon et passible de poursuite conformément aux dispositions des articles L.335-2 et suivants du Code de Propriété Intellectuelle.</p>
        <p>Toute reproduction totale ou partielle de l'affichage, edition, adaptation totalement ou partiellement de l'un de ces éléments, peu importe le  moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de Mathieu LEHR, responsable du site suivant à cette adresse : mathieu.lehr@gmail.com, à contrario elle sera considérée comme constitutive d'une contrefaçon étant passible de poursuite d'après les dispositions des différents articles L.335-2 et suivants du Code de Propriété Intellectuelle.</p>
        <p>Bon nombre d'images présente sur le site barbofus.com sont la propriété d'Ankama Games et Dofus.</p>

...
@section('content')
    ...
    {{-- Envoie le résultat du form à la route de store --}}
    <form method="POST" action='{{ route('builds.store') }}' enctype="multipart/form-data" class="flex justify-center">
      ...
      <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
        ...
        {{-- Choix du mode PVP ou PVM --}}
        <div class="-mx-3 mb-5 pl-[250px]">
          <div class="w-[50%] px-3">
              <label for="" class="text-l font-semibold px-1">Choix du mode PVP ou PVM</label>
              
              <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
              <select name="is_pvp" id="is_pvp">
                  <option value="1">PVP</option>
                  <option value="0">PVM</option>
              </select>
          </div>
        </div>

<div class="h-full w-full">
    ...
    <a class="slidingCard absolute group h-full w-full" title="Skin {{ $skin->race_name }} de {{ $skin->user_name }}" href="{{ route('skins.show', $id) }}">
        ...
        @if($skin->user_name === 'Barbe Douce' &! isset($showBarbe))
            <img class="absolute top-0 left-0 h-[25%] max-h-[64px] peer cursor-pointer" width="64" height="64" alt="Logo Barbe" loading="lazy" src="{{ asset('storage/images/misc_ui/logo_barbe.png') }}" draggable="false">
        @endif
                ...
                @elseif($skin->reward_id == 2)
                    ...
                    <div class="absolute h-10 w-10 left-[50%+1.25rem]">
                        <div class="absolute animate-slideY [--custom-translate-y:3px] [--custom-animation-time:5s] h-full w-full" style="animation-delay: -1250ms">
                            <img src="{{ asset('storage/images/misc_ui/symbol_emeraude_orb.png') }}" height="16" width="16" loading="lazy" alt="Orbe" draggable="false" class="absolute brightness-200 scale-[.3] h-full top-[-15px] right-[-2px] animate-slideX [--custom-translate-x:3px] [--custom-animation-time:5s]">
                        </div>
                        <div class="absolute animate-slideY [--custom-translate-y:3px] [--custom-animation-time:5s] h-full w-full" style="animation-delay: -1250ms">
                            <img src="{{ asset('storage/images/misc_ui/symbol_emeraude_orb.png') }}" height="16" width="16" loading="lazy" alt="Orbe" draggable="false" class="absolute brightness-150 scale-[.35] h-full top-[-9px] right-[17px] animate-slideX [--custom-translate-x:-3px] [--custom-animation-time:5s]">
                        </div>
                        <div class="absolute animate-slideY [--custom-translate-y:3px] [--custom-animation-time:5s] h-full w-full" style="animation-delay: -2500ms">
                            <img src="{{ asset('storage/images/misc_ui/symbol_emeraude_orb.png') }}" height="16" width="16" loading="lazy" alt="Orbe" draggable="false" class="absolute brightness-200 scale-[.3] h-full top-[-9px] right-[-15px] animate-slideX [--custom-translate-x:3px] [--custom-animation-time:5s]" style="animation-delay: -1250ms">
                        </div>
                        <div class="absolute animate-slideY [--custom-translate-y:3px] [--custom-animation-time:5s] h-full w-full" style="animation-delay: -2500ms">
                            <img src="{{ asset('storage/images/misc_ui/symbol_emeraude_orb.png') }}" height="16" width="16" loading="lazy" alt="Orbe" draggable="false" class="absolute brightness-125 scale-[.3] h-full top-[2px] right-[16px] animate-slideX [--custom-translate-x:-3px] [--custom-animation-time:5s]" style="animation-delay: -1250ms">
                        </div>
                        <div class="absolute animate-slideY [--custom-translate-y:3px] [--custom-animation-time:5s] h-full w-full" style="animation-delay: -3500ms">
                            <img src="{{ asset('storage/images/misc_ui/symbol_emeraude_orb.png') }}" height="16" width="16" loading="lazy" alt="Orbe" draggable="false" class="absolute brightness-150 scale-[.4] h-full top-[4px] right-[-15px] animate-slideX [--custom-translate-x:3px] [--custom-animation-time:5s]" style="animation-delay: -2250ms">
                        </div>
                        <div class="absolute animate-slideY [--custom-translate-y:3px] [--custom-animation-time:5s] h-full w-full" style="animation-delay: -3500ms">
                            <img src="{{ asset('storage/images/misc_ui/symbol_emeraude_orb.png') }}" height="16" width="16" loading="lazy" alt="Orbe" draggable="false" class="absolute brightness-150 scale-[.3] h-full top-[5px] right-[-27px] animate-slideX [--custom-translate-x:-3px] [--custom-animation-time:5s]" style="animation-delay: -2250ms">
                        </div>
                        <div class="absolute animate-slideY [--custom-translate-y:3px] [--custom-animation-time:5s] h-full w-full" style="animation-delay: -1250ms">
                            <img src="{{ asset('storage/images/misc_ui/symbol_emeraude_orb.png') }}" height="16" width="16" loading="lazy" alt="Orbe" draggable="false" class="absolute scale-[.4] h-full top-[8px] right-[27px] animate-slideX [--custom-translate-x:3px] [--custom-animation-time:5s]">
                        </div>
                        <div class="absolute animate-slideY [--custom-translate-y:3px] [--custom-animation-time:5s] h-full w-full" style="animation-delay: -1250ms">
                            <img src="{{ asset('storage/images/misc_ui/symbol_emeraude_orb.png') }}" height="16" width="16" loading="lazy" alt="Orbe" draggable="false" class="absolute scale-[.5] h-full top-[14px] right-[20px] animate-slideX [--custom-translate-x:-3px] [--custom-animation-time:5s]">
                        </div>
                        <div class="absolute animate-slideY [--custom-translate-y:3px] [--custom-animation-time:5s] h-full w-full" style="animation-delay: -2750ms">
                            <img src="{{ asset('storage/images/misc_ui/symbol_emeraude_orb.png') }}" height="16" width="16" loading="lazy" alt="Orbe" draggable="false" class="absolute brightness-125 scale-[.5] h-full top-[13px] right-[-17px] animate-slideX [--custom-translate-x:3px] [--custom-animation-time:5s]" style="animation-delay: -1500ms">
                        </div>
                    </div>
        ...
        <img src="{{ asset('storage\/') . $skin->image_path }}" title="Skin {{ $skin->race_name }} de {{ $skin->user_name }}" height="390" width="300" loading="lazy" class="absolute top-[10%] left-[5%] h-[80%] cursor-pointer group-hover:scale-105 transition-transform" draggable="false">
    </a>
</div>

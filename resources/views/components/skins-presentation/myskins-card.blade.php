...
<div class="aspect-[14/19] h-full relative w-full group">
    ...
    <div class="absolute w-full text-inactiveText flex justify-between px-2 top-2">
        <a href="{{ route(((isset($skin->is_unity_skin)) ? (($skin->is_unity_skin) ? 'skinator.edit' : 'skins.edit') : 'skins.edit'), $skin->id) }}">
        ...
        <button x-on:click="skinDeleteID = {{ $skin->id }}, skinDeleteImg = '{{ asset('storage/' . $skin->image_path) }}'">

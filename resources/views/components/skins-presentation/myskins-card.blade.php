...
<div class="aspect-[14/19] h-full relative w-full group">
    ...
    <div class="absolute w-full text-inactiveText flex justify-between px-2 top-2">
        <a href="{{ route(((Gate::check('mod-access') || Gate::check('admin-access')) ? 'skinator.edit' : ((isset($skin->is_unity_skin)) ? (($skin->is_unity_skin) ? 'unity-skins.edit' : 'skins.edit') : 'skins.edit')), $skin->id) }}">

...
<!-- Navbar -->
<nav id="navbar"
     class="fixed min-[1301px]:sticky min-[1301px]:z-40 z-40 top-0 min-[1301px]:top-10 min-[1301px]:border-t-8 min-[1301px]:border-secondary h-12 w-full tracking-tight text-[1.35rem] text-inactiveText font-thin bg-primary pb-[0.75rem] min-[1301px]:pt-2"
     x-data="{
            title: {
                'skins.index': 'Skins',
                'skins.show': 'Skins',
            ...
            selectedClass: 'max-[1300px]:border-y max-[1300px]:border-secondary max-[1300px]:flex max-[1300px]:items-center max-[1300px]:px-5 min-[1301px]:pl-5 h-[12%] min-[1301px]:h-[2rem] text-secondary-100 font-light flex min-[1301px]:after:ml-5 min-[1301px]:after:-mt-1 min-[1301px]:after:clip-path-triangle-down min-[1301px]:after:block min-[1301px]:after:h-[2.25rem] min-[1301px]:after:w-[5rem] min-[1301px]:after:bg-secondary focus:outline-none',
    ...
    <template x-if="true">
        <div x-show="showNavbar" x-transition
             class="flex h-[max(100vh,15.625rem)] w-screen max-[1300px]:pb-2 min-[1301px]:h-full min-[1301px]:w-full items-center justify-center flex-col min-[1301px]:flex-row bg-primary">

...
<button
    ...
    class="fixed z-50 flex items-center justify-center w-16 h-16 rounded-full shadow-sm right-4 bg-ivory bottom-6 group">
    <svg
        class="w-10 transition-all duration-150 text-anthracite group-hover:-translate-y-1"

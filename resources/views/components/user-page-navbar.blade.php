<div class="flex justify-center mt-20 mb-10">
    ...
    <div
        ...
        <div class="min-[1250px]:w-[315px] max-h-[390px] font-light sticky top-32">
            ...
            <button x-on:click="currentPage = 'user-details'" :class="(currentPage == 'user-details') ? activeButtonClass : initButtonClass" x-cloak>
            ...
            <button x-on:click="currentPage = 'my-skins'" :class="(currentPage == 'my-skins') ? activeButtonClass : initButtonClass" x-cloak>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            <button x-on:click="currentPage = 'my-likes'" :class="(currentPage == 'my-likes') ? activeButtonClass : initButtonClass" x-cloak>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            @can('validate-skin')
                <button x-on:click="currentPage = 'skins-validation'" :class="(currentPage == 'skins-validation') ? activeButtonClass : initButtonClass" x-cloak>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
            ...
            @can('admin-access')
                ...
                <button x-on:click="currentPage = 'users-list'" :class="(currentPage == 'users-list') ? activeButtonClass : initButtonClass" x-cloak>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                ...
                <button x-on:click="currentPage = 'admin-panel'" :class="(currentPage == 'admin-panel') ? activeButtonClass : initButtonClass" x-cloak>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
        ...
        <div class="min-h-[50vh] flex-grow relative">
            <div x-show="currentPage == 'user-details'"
            ...
            <div x-show="currentPage == 'my-skins'"
                 x-transition:enter="transition ease-out duration-300"
                 x-transition:enter-start="opacity-0 -translate-y-8"
                 x-transition:enter-end="opacity-100">
            ...
            <div x-show="currentPage == 'my-likes'"
                 x-transition:enter="transition ease-out duration-300"
                 x-transition:enter-start="opacity-0 -translate-y-8"
                 x-transition:enter-end="opacity-100">
            ...
            @can('admin-access')
                <div x-show="currentPage == 'users-list'"
                     x-transition:enter="transition ease-out duration-300"
                     x-transition:enter-start="opacity-0 -translate-y-8"
                     x-transition:enter-end="opacity-100">
                ...
                <div x-show="currentPage == 'admin-panel'"
                     x-transition:enter="transition ease-out duration-300"
                     x-transition:enter-start="opacity-0 -translate-y-8"
                     x-transition:enter-end="opacity-100">

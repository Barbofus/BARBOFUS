<div class="flex justify-center mt-36 mb-10">
    ...
    <div
        ...
        x-data="{
            initButtonClass: 'border-b-2 transition-all text-inactiveText border-primary px-2 min-[1250px]:px-6 h-[65px] flex gap-x-2 items-center text-left text-xl w-full hover:bg-primary-100 [&:hover:not(.active)>p]:-skew-x-12 hover:text-secondary [&.active]:font-normal [&.active]:border-secondary [&.active]:text-secondary [&.active]:text-2xl fill-inactiveText [&.active]:fill-secondary',
            initTextClass: 'absolute invisible min-[1250px]:visible min-[1250px]:static transition-transform',

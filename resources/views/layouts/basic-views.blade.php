...
@section('app-content')
    ...
    <div x-data="{
        ...
        <div class="absolute top-0 w-full h-full transition-all duration-700 scale-x-0 -translate-x-1/2 opacity-0 left-1/2 emeraldGradient group-hover:scale-x-100 group-hover:opacity-100"></div>
        <a href="https://youtu.be/42wbG24vJQ4" target="_blank" class="relative z-10 flex items-center justify-center w-full h-full">
            <p x-html="randomMessage"></p>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 transition-all origin-bottom-left group-hover:scale-150">

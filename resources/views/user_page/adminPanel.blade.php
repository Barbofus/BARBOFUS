...
@section('user-page-content')
    <div x-data="{
        ...
        <div class="flex items-center justify-center mt-10"
            ...
            <svg aria-hidden="true" class="w-10 mr-2 text-gray-200 animate-spin fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="text-2xl text-gray-800">Récupération des items</p>
        </div>
    </div>
@endsection

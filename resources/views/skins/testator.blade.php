            ...
            <div class="flex flex-col min-[1249px]:flex-row h-full">
                ...
                <div class="w-full min-[600px]:w-[max(min(20vw,25.5rem),23rem)]">
                    ...
                    <div class="flex mx-auto gap-x-4 w-fit"
                        x-on:change="if (event.target.matches('input[type=radio]')) { shouldResetColors = checkIfDefaultColors(gender, breed, colors); gender = Number(event.target.value); editURLParam(getURLObject()); updateAlpineHead(); }">
                        <div>
                    ...
                    <div x-cloak class="py-4 min-[600px]:px-4" x-show="charactersCurrentTab === 'breed'">
                        ...
                        <div class="flex flex-wrap items-center justify-center gap-2"
                            x-on:change="if (event.target.matches('input[type=radio]')) { shouldResetColors = checkIfDefaultColors(gender, breed, colors); breed = Number(event.target.value); editURLParam(getURLObject()); updateAlpineHead(); }">

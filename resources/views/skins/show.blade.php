...
@section('content')
    ...
    <div
        class="relative flex flex-col gap-y-1 min-[950px]:gap-y-4 h-[91rem] min-[950px]:h-fit py-4 w-[min(95rem,95vw)] mx-auto overflow-hidden min-[950px]:mt-4 min-[950px]:rounded-lg min-[950px]:bg-black min-[950px]:bg-opacity-[0.09] min-[950px]:shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]"
        ...
        <div class="flex gap-x-4 items-center justify-center mt-11 min-[950px]:mt-4">
            ...
            {{-- Likes --}}
            @auth()
                <form method="post" action="{{ route('skins.like', ['id' => $skin->id]) }}">
                    @csrf
                    <button @if($skin->user_id === Auth::id()) disabled @endif aria-label="Aimer un skin" class="h-12 @if($skin->user_id != Auth::id()) hover:brightness-125 @endif">
        ...
        <div class="flex flex-col gap-y-4 items-center min-[950px]:pt-24 relative h-full">
            ...
            <div class="flex flex-row min-[420px]:flex-col items-center gap-x-4 gap-y-4 mt-4">
                ...
                <div class="flex flex-col min-[420px]:flex-row gap-x-4">
                    <div
                        class="min-[950px]:absolute top-0 min-[950px]:-translate-y-0 min-[950px]:-translate-x-[3.5rem] [@media(min-height:920px)_and_(min-width:1100px)]:translate-y-[35rem] [@media(min-height:920px)_and_(min-width:1100px)]:-translate-x-[11.5rem]">
                        <x-skins-presentation.color name="Habits 1" color="{{ $skin->color_cloth_1 }}"/>
                    </div>

                    <div
                        class="min-[950px]:absolute top-0 min-[950px]:-translate-y-0 min-[950px]:translate-x-[4.5rem] [@media(min-height:920px)_and_(min-width:1100px)]:translate-y-[35rem] [@media(min-height:920px)_and_(min-width:1100px)]:-translate-x-[3.5rem]">
                        <x-skins-presentation.color name="Habits 2" color="{{ $skin->color_cloth_2 }}"/>
                    </div>

                    <div
                        class="min-[950px]:absolute top-0 min-[950px]:-translate-y-0 min-[950px]:translate-x-[12.5rem] [@media(min-height:920px)_and_(min-width:1100px)]:translate-y-[35rem] [@media(min-height:920px)_and_(min-width:1100px)]:translate-x-[4.5rem]">
                ...
                @if(isset($skin->dofus_item_costume_level))
                    <div
                        ...
                        <img src="{{ asset('storage/images/misc_ui/costume_arrow.png') }}"
                             class="absolute invisible min-[950px]:animate-slideX [--custom-translate-x:5px] [--custom-animation-time:5s] min-[950px]:visible top-[-2.5rem] right-[-12rem]">
                    </div>
                @endif
                ...
                @if(isset($skin->dofus_item_shield_level))
                    <div
                        ...
                        <img src="{{ asset('storage/images/misc_ui/shield_arrow.png') }}"
                             class="absolute invisible min-[950px]:animate-slideX [--custom-translate-x:5px] [--custom-animation-time:5s] min-[950px]:visible top-[-3rem] right-[-5rem]">
                    </div>
                @endif
                ...
                @if(isset($skin->dofus_item_pet_level))
                    <div
                        ...
                        <img src="{{ asset('storage/images/misc_ui/pet_arrow.png') }}"
                             class="absolute min-[950px]:animate-slideX [--custom-translate-x:5px] [--custom-animation-time:5s] invisible min-[950px]:visible bottom-[-5rem] right-[-5rem]"
                             style="animation-delay: -1250ms">
                    </div>
                @endif
                ...
                @if(isset($skin->dofus_item_hat_level))
                    <div
                        ...
                        <img src="{{ asset('storage/images/misc_ui/hat_arrow.png') }}"
                             class="absolute min-[950px]:animate-slideX [--custom-translate-x:5px] [--custom-animation-time:5s] invisible min-[950px]:visible top-[-4.5rem] left-[-5rem]">
                    </div>
                @endif
                ...
                @if(isset($skin->dofus_item_cloak_level))
                    <div
                        ...
                        <img src="{{ asset('storage/images/misc_ui/cloak_arrow.png') }}"
                             class="absolute min-[950px]:animate-slideY [--custom-translate-y:5px] [--custom-animation-time:5s] invisible min-[950px]:visible top-[-3rem] left-[-9rem]"
                             style="animation-delay: -1250ms">
                    </div>
                @endif
            </div>
